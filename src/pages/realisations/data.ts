...
export const projetsData: ProjectData = {
  'budget-participatif': {
    ...
    description: 'Développement d\'une plateforme digitale innovante permettant aux citoyens de Labé de participer activement au processus budgétaire de leur commune.',
    challenge: 'La municipalité de Labé souhaitait moderniser son processus de budget participatif et augmenter l\'engagement citoyen dans les décisions budgétaires locales.',
    ...
    testimonial: {
      ...
      author: 'Fatou Diop',
      role: 'Maire adjointe, Commune de Labé',
  ...
  'open-data-observatory': {
    ...
    client: 'Gouvernement de la Guinée',
    ...
    description: 'Portail national centralisant les données publiques guinéennes.',
    ...
    testimonial: {
      quote: 'Transformé l\'accès aux informations publiques en Guinée.',
  ...
  'youth-bootcamp': {
    ...
    challenge: 'Jeunes guinéens manquent de compétences techniques.',
  ...
  'hackathon-open-data': {
    title: 'Hackathon Open Data Guinée',
    category: 'Événement',
    ...
    description: 'Hackathon dédié aux données ouvertes en Guinée.',
    ...
    testimonial: {
      quote: 'Innovation citoyenne catalysée en Guinée.',
      author: 'Modou Diop',
